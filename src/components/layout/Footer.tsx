...
export function Footer() {
  ...
  return (
    <footer id="footer" className="bg-[#B7B3A7] relative overflow-hidden">
      {/* Top gold line */}
      ...
      <div className="container-wide relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 lg:gap-12 py-12 md:py-16">
          ...
          >
            <div className="mb-6">
              <div className="font-display font-black text-2xl tracking-[0.07em] text-[#1C1914]">SALUS</div>
              <div className="font-sans font-semibold tracking-[0.4em] text-[#96690A] mt-0.5" style={{ fontSize: "9px" }}>FITNESS</div>
            </div>
            <p className="font-body text-[#8C8776] text-sm leading-[1.8] mb-7 max-w-[240px]">
            ...
            <div className="flex items-center gap-2">
              ...
              <motion.button
                ...
                className="w-9 h-9 rounded-full border border-[#A29D8F] flex items-center justify-center text-[#8C8776] hover:border-[#E1306C] hover:text-[#E1306C] transition-all duration-300 cursor-pointer bg-transparent"
              ...
              {[
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.1, y: -2 }}
                  className={`w-9 h-9 rounded-full border border-[#A29D8F] flex items-center justify-center text-[#8C8776] ${s.hover} transition-all duration-300`}
                >
                  <s.icon size={14} />
                </motion.a>
              ))}
              ...
              {QUICK_LINKS.map((link) => (
                <li key={link.label}>
                  <button
                    ...
                    className="group flex items-center gap-2 font-body text-[#8C8776] hover:text-[#96690A] text-sm transition-colors duration-300 cursor-pointer bg-transparent border-none p-0"
                  >
                    <span className="w-0 group-hover:w-3 h-px bg-[#96690A] transition-all duration-300 overflow-hidden flex-shrink-0" />
                    {link.label}
                  </button>
                </li>
              ))}
          ...
          >
            ...
            <ul className="space-y-4">
              <li>
                <a href="tel:7674014383" className="flex items-start gap-3 text-[#8C8776] hover:text-[#96690A] transition-colors duration-300">
                  <Phone size={13} className="text-[#96690A] flex-shrink-0 mt-0.5" />
                  <div className="font-body text-sm">
                    <div>76740 14383</div>
                    <div className="text-[#8C8776] mt-0.5 text-xs">86866 56564</div>
                  </div>
                </a>
              </li>
              <li>
              ...
              <li>
                <a
                  ...
                  className="flex items-start gap-3 text-[#8C8776] hover:text-[#96690A] transition-colors duration-300"
                >
                  <MapPin size={13} className="text-[#96690A] flex-shrink-0 mt-0.5" />
                  <div className="font-body text-sm leading-relaxed">
                    Green Hills Colony Rd No. 3
                    <br />
                    <span className="text-[#8C8776] text-xs">Hyderabad, Telangana</span>
                  </div>
                </a>
              </li>
            </ul>
            ...
            <ul className="space-y-3">
              {HOURS.map((h) => (
                <li key={h.day} className="flex items-start gap-3">
                  <Clock size={13} className="text-[#96690A] flex-shrink-0 mt-0.5" />
                  <div className="font-body text-sm">
                    <div className="text-[#6B6658]">{h.day}</div>
                    <div className="text-[#8C8776] text-xs mt-0.5">{h.time}</div>
                  </div>
                </li>
              ))}
            </ul>
        ...
        <motion.div
          ...
          className="border-t border-[#A29D8F] pt-8 pb-4 mb-8"
        >
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <Link
                key={l.href}
                href={l.href}
                className="font-body text-[#8C8776] hover:text-[#96690A] text-xs border border-[#A29D8F] hover:border-[rgba(150,105,10,0.3)] px-3 py-1.5 rounded-full transition-all duration-300"
              >
                {l.label}
              </Link>
            ))}
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.7, ease: [0.16,1,0.3,1] }}
          className="mb-10 rounded-2xl overflow-hidden border border-[#A29D8F]"
        >
          <iframe
        ...
        {/* Bottom bar */}
        <div className="border-t border-[#A29D8F] py-6 flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="font-body text-[#8C8776] text-xs">
            © {new Date().getFullYear()} Salus Fitness. All rights reserved.
            <span className="ml-2 text-[rgba(150,105,10,0.6)]">@salus_fitnessgym</span>
          </p>
          <p className="font-body text-[#A29D8F] text-[11px]">
